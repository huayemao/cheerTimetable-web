    ...
    <div ref={ref} className={'relative inline-block w-full ' + className}>
      <span className="rounded-md shadow-sm">
        <button
          ...
          className="border-accent-3 bg-accent-0 focus:outline:none flex w-full justify-between rounded-md border px-4 py-3 text-sm leading-5 text-gray-500  duration-150 ease-in-out hover:text-slate-700 focus:border-blue-300 active:bg-slate-100 active:text-slate-700"
          id="options-menu"
          aria-haspopup="true"
          aria-expanded="true"
        >
